...
// let nameGreeting = nameCheck('blah')
...
//CODE HERE // HAVE QUESTIONS , HAVEN'T COMPLETED~~~~~~~~~~~~~~~~~~~~~~~
...
//CODE HERE
// function froggy(goldBudget) {
//   const frogCost = 3 ;
//   let totalFrogs = goldBudget / 3 ;
//   console.log(Math.floor(totalFrogs));
// }

// froggy(32)

////////////////// PROBLEM 15 ////////////////////                     ~~~~~~~~~~~~INCOMPLETE: HAVE QUESTIONS~~~~~~~~~~~~~~~~~~
                                                                        // how to sort and compare??
let sampleArray = [0,1,2,3,2,7,5,6,8,9]
/*
  Write a function that takes in an array of numbers as an argument. In the body of the function, write logic to determine if the array is in ascending order. The function should return true, if it is sorted in ascending order, false if it is not. Create a variable, `arrayIsAscending` and set it equal to your function invoked. Use the sample array to test this function.
*/

//CODE HERE
// function orderTest(arr) {
//   for (let i = 0; i < sampleArray.length; i++) {
//     let sorted = sampleArray.sort((a, b) => a - b);
//     if (sampleArray === sorted) {
//       console.log(true);
//     } else {
//       console.log(false);
//     }
//   }
//   let arrayIsAscending = orderTest
// }

// orderTest(sampleArray)
